...
void Albany::ExtrudedSTKMeshStruct::setFieldAndBulkData_1(
    const Teuchos::RCP<const Teuchos_Comm>& comm,
    ...
    const std::map<std::string,AbstractFieldContainer::FieldContainerRequirements>& side_set_req)
{
  ...
  this->sideSetMeshStructs.at("basalside")->setFieldAndBulkData_1 (comm, params2D, basal_req, basal_sis, worksetSize);
    ...
    const std::map<std::string,AbstractFieldContainer::FieldContainerRequirements>& side_set_req)
{
  ...
  this->sideSetMeshStructs.at("basalside")->setFieldAndBulkData_2 (comm, params2D, basal_req, basal_sis, worksetSize);
