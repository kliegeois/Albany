...
RandomPhysicalParameter<EvalT, Traits>::RandomPhysicalParameter(const Teuchos::ParameterList&)
{
  this->setName("Random Physical Parameter");
}
...
template <typename EvalT, typename Traits>
void
RandomPhysicalParameter<EvalT, Traits>::postRegistrationSetup(
...
//
template <typename EvalT, typename Traits>
void RandomPhysicalParameter<EvalT, Traits>::evaluateFields(
...
RandomPhysicalParameter<PHAL::AlbanyTraits::Residual, Traits>::RandomPhysicalParameter(
...
template <typename Traits>
void
RandomPhysicalParameter<PHAL::AlbanyTraits::Residual, Traits>::postRegistrationSetup(
...
template <typename Traits>
void
RandomPhysicalParameter<PHAL::AlbanyTraits::Residual, Traits>::evaluateFields(
    typename Traits::EvalData workset)
{
  if (field_type == "Cell") {
...
template <typename Traits>
void
RandomPhysicalParameter<PHAL::AlbanyTraits::Residual, Traits>::readElemState(
    typename Traits::EvalData workset)
{
...
template <typename Traits>
void
RandomPhysicalParameter<PHAL::AlbanyTraits::Residual, Traits>::readNodalState(
    typename Traits::EvalData workset)
{
